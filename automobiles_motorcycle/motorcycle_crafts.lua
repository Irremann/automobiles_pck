...
if minetest.get_modpath("default") then
	minetest.register_craft({
		...
		recipe = {
			{"pipeworks:pipe_1_empty", "mobs:leather", ""},
			{"pipeworks:pipe_1_empty", "default:steel_ingot", "default:steel_ingot"},
			{"automobiles_motorcycle:wheel", "automobiles_lib:engine", "automobiles_motorcycle:wheel"},
		}
	})
	minetest.register_craft({
